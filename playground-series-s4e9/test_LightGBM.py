...
def lgb_evaluate(X_train, y_train, num_leaves, learning_rate, n_estimators, subsample, colsample_bytree, min_child_weight):
...
def main():
    ...
    lgb_bo = BayesianOptimization(
        lambda max_depth, learning_rate, n_estimators, subsample, colsample_bytree, min_child_weight: lgb_evaluate(
